...
def parse_args():
    ...
    train_parser.add_argument("--test-task-class", type=str, choices=["basic","doors","buttons","complex"], default="complex",  help="Task class for periodic validation (default: complex)")
    train_parser.add_argument("--test-complexity-level", type=float, default=1.0, help="Complexity level for periodic validation (default: 1.0)")
